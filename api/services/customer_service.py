...
def get_or_create_customer(name: str, email: str) -> Customer:
...
def update_customer(customer_id: UUID, name: Optional[str] = None, email: Optional[str] = None) -> Optional[Customer]:
