...
class PaymentHistorySerializer:
    ...
    def serialize(self):
        return{
            ...
            "customer_name": self._payment.customer.name if self._payment.customer else None,
            "customer_email": self._payment.customer.email if self._payment.customer else None,
